 ...
 * The only public way to create an engine. It is exposed to allow different engine packaging methods in other JQM artifacts (and one day
 * may become the entry point of an "embedded JQM library").
 *
 */
